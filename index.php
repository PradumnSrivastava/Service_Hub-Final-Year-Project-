...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
    <a href="index.php" class="navbar-brand">Service Hub</a>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/Banner1.jpeg);">
    <div class="myclass mainHeading">
      <h1 class="text-uppercase text-danger font-weight-bold">Welcome to Service Hub</h1>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      <h3 class="text-center">Service Hub</h3>
      <p>
        Service Hub Services is India’s leading chain of multi-brand Electronics and Electrical service
        workshops offering
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        <br><br>
        <strong>Prayagraj Branch:</strong> <br>
        Service Hub, <br>
        Naini,  <br>
        Prayagraj - 211011 <br>
        Phone: +00000000 <br>
        <a href="#" target="_blank">www.servicehub.com</a> <br>
